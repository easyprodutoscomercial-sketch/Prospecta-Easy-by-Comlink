...
// GET /api/suporte/[id]/attachments - Listar anexos do ticket
export async function GET(
  ...
  try {
    ...
    console.error('Error listing support attachments:', error);
...
// POST /api/suporte/[id]/attachments - Upload anexo do ticket
export async function POST(
  ...
  try {
    ...
    const filePath = `${profile.organization_id}/suporte/${id}/${safeName}`;
