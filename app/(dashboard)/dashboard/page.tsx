...
export default async function DashboardPage() {
  ...
  const [
    ...
    admin.from('contacts').select('id, status, stage_id, created_at, created_by_user_id, tipo, valor_estimado, assigned_to_user_id, temperatura, origem, classe, estado, cidade, proxima_acao_tipo, cpf, cnpj, phone, whatsapp, company, referencia, contato_nome, cargo, produtos_fornecidos, pipeline_id').eq('organization_id', orgId),
    ...
    admin.from('contacts').select('id, status, stage_id, created_by_user_id, tipo, temperatura, origem, classe, assigned_to_user_id, estado, cidade, proxima_acao_tipo, cpf, cnpj, phone, whatsapp, company, referencia, contato_nome, cargo, produtos_fornecidos, pipeline_id').eq('organization_id', orgId).gte('created_at', monthStart).lt('created_at', monthEnd),
