      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2 self-start">
          <a
            ...
            className="px-3 py-2.5 bg-purple-800/30 text-purple-200/80 border border-purple-700/30 rounded-lg font-medium hover:bg-purple-800/50 hover:text-white transition-colors text-sm flex items-center gap-2"
            title="Historico de feiras encerradas"
          >
          ...
          <button
            ...
            className="px-4 py-2.5 bg-emerald-500 text-white rounded-lg font-medium hover:bg-emerald-600 transition-colors text-sm flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
