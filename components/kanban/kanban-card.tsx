        ...
        <div className="flex items-center gap-1 ml-auto">
          {(contact.whatsapp || contact.phone) && (
            <a
              ...
              className="w-5 h-5 flex items-center justify-center rounded hover:bg-green-500/20 transition-colors"
              title="WhatsApp"
            >
          ...
          {contact.email && (
            <a
              ...
              onClick={(e) => e.stopPropagation()}
              className="w-5 h-5 flex items-center justify-center rounded hover:bg-blue-500/20 transition-colors"
              title="Email"
            >
          ...
          {contact.phone && (
            <a
              ...
              onClick={(e) => e.stopPropagation()}
              className="w-5 h-5 flex items-center justify-center rounded hover:bg-purple-500/20 transition-colors"
              title="Ligar"
            >
